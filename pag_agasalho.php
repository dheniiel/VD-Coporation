...
<body>
    ...
    <br> <br> <br>
    <div class="container">
        <center> <img class="product-image" src="src/img/jaquetat.png" alt="Seu Produto" width="400" height="400"> </center> <br> <br> 
    ...
    <div class="container">
        <center> <img class="product-image" src="src/img/bobojaco.jpg" alt="Seu Produto" width="400" height="400"> </center> <br> <br> 
        <p class="product-description">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed eget libero at ipsum blandit gravida vel in purus.
        </p>
        <p class="price">R$ 99,99</p>
    ...
    <div class="container">
        <center> <img class="product-image" src="src/img/saude.png" alt="Seu Produto" width="400" height="400"> </center> <br> <br> 
        <p class="product-description">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed eget libero at ipsum blandit gravida vel in purus.
        </p>
        <p class="price">R$ 99,99</p>
    ...
    <div class="container">
        <center> <img class="product-image" src="src/img/adidas.png" alt="Seu Produto" width="400" height="400"> </center> <br> <br> 
        <p class="product-description">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed eget libero at ipsum blandit gravida vel in purus.
        </p>
        <p class="price">R$ 99,99</p>
    ...
    <div class="container">
        <center> <img class="product-image" src="src/img/camuflado.png" alt="Seu Produto" width="400" height="400"> </center> <br> <br> 
        <p class="product-description">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed eget libero at ipsum blandit gravida vel in purus.
        </p>
        <p class="price">R$ 99,99</p>
